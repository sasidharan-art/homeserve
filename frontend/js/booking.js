...
const state = { step: 1, service: null, selectedTime: "", basePrice: 0, customerLocation: null };
...
function calculatePrice() {
  ...
  $("totalPrice").textContent = money(base + visit + emergency + tax);
  return { base, visit, emergency, tax: Math.round(tax), total: Math.round(base + visit + emergency + tax) };
}
